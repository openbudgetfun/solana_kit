...
This monorepo contains **55 packages** under `packages/`: **51 publishable** and **4 internal** (`solana_kit_address`, `solana_kit_address_constants`, `solana_kit_lints`, `solana_kit_test_matchers`).
