...
| ------------------------------------------------ | ----------------------------------------------------------------------------------------------------- | ------------------------------------------ | -------------------------------------------------------------------------------------- |
| `.repos/solana-program/system`                   | [solana-program/system](https://github.com/solana-program/system)                                     | `js@v0.14.0`                               | `solana_kit_system` (#131)                                                             |
| `.repos/solana-program/token`                    | [solana-program/token](https://github.com/solana-program/token)                                       | `js@v0.16.0`                               | `solana_kit_token`                                                                     |
| `.repos/solana-program/token-2022`               | [solana-program/token-2022](https://github.com/solana-program/token-2022)                             | `js@v0.16.0`                               | `solana_kit_token_2022`                                                                |
...
| `.repos/solana-program/address-lookup-table`     | [solana-program/address-lookup-table](https://github.com/solana-program/address-lookup-table)         | `js@v0.14.0`                               | `solana_kit_address_lookup_table` (#134)                                               |
| `.repos/solana-program/memo`                     | [solana-program/memo](https://github.com/solana-program/memo)                                         | `js@v0.13.0`                               | `solana_kit_memo` (#135)                                                               |
| `.repos/solana-program/compute-budget`           | [solana-program/compute-budget](https://github.com/solana-program/compute-budget)                     | `js@v0.18.0`                               | `solana_kit_compute_budget` (#133)                                                     |
| `.repos/solana-program/stake`                    | [solana-program/stake](https://github.com/solana-program/stake)                                       | `js@v0.9.0`                                | `solana_kit_stake` (#136)                                                              |
