...
- `.repos/mobile-wallet-adapter` — Solana Mobile Wallet Adapter reference from `solana-mobile/mobile-wallet-adapter` (last checked `bed51fa2f177`)
...
| `.repos/solana-program/loader-v3`                | [solana-program/loader-v3](https://github.com/solana-program/loader-v3)                               | `js@v0.4.0`                               | `solana_kit_loader` (#138)                                                             |
