...
| `.repos/solana-foundation/subscriptions`         | [solana-foundation/subscriptions](https://github.com/solana-foundation/subscriptions)                 | `ts-client-v0.3.0`                        | `solana_kit_subscriptions`                                                             |
...
| `.repos/solana-program/memo`                     | [solana-program/memo](https://github.com/solana-program/memo)                                         | `js@v0.11.1`                              | `solana_kit_memo` (#135)                                                               |
...
| `.repos/solana-program/stake`                    | [solana-program/stake](https://github.com/solana-program/stake)                                       | `js@v0.6.1`                               | `solana_kit_stake` (#136)                                                              |
