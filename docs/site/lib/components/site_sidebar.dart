      ...
      groups: [
        ...
        SidebarGroup(
          ...
          links: [
            ...
            SidebarLink(
              ...
              href: link('/getting-started/first-transaction'),
            ),
          ],
        ),
        SidebarGroup(
          ...
          links: [
            ...
            SidebarLink(
              text: 'RPC & Subscriptions',
              href: link('/core/rpc-and-subscriptions'),
            ),
            SidebarLink(text: 'Transactions', href: link('/core/transactions')),
            SidebarLink(
              text: 'Errors & Diagnostics',
              href: link('/core/errors-and-diagnostics'),
            ),
          ],
        ),
        SidebarGroup(
          ...
          links: [
            SidebarLink(
              text: 'Build an RPC Service',
              href: link('/guides/build-rpc-service'),
            ),
            SidebarLink(
              text: 'Build a Token Transfer Flow',
              href: link('/guides/build-token-transfer-flow'),
            ),
            SidebarLink(
              text: 'Build a Program Client',
              href: link('/guides/build-program-client'),
            ),
            SidebarLink(
              text: 'Build a Realtime Observer',
        ...
        SidebarGroup(
          ...
          links: [
            SidebarLink(
              text: 'Package Index',
              href: link('/reference/package-index'),
            ),
            SidebarLink(
              text: 'Complete Package Catalog',
              href: link('/reference/package-catalog'),
            ),
            SidebarLink(
              text: 'Upstream Compatibility',
              href: link('/reference/upstream-compatibility'),
            ),
