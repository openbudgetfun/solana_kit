...
| [system](https://github.com/solana-program/system)                                            | `js@v0.15.0`                                              | `solana_kit_system`                                                             |
| [token](https://github.com/solana-program/token)                                              | `js@v0.17.0`                                              | `solana_kit_token`                                                              |
| [token-2022](https://github.com/solana-program/token-2022)                                    | `js@v0.19.0`                                              | `solana_kit_token_2022`                                                         |
...
| [address-lookup-table](https://github.com/solana-program/address-lookup-table)                | `js@v0.15.0`                                              | `solana_kit_address_lookup_table`                                               |
| [memo](https://github.com/solana-program/memo)                                                | `js@v0.15.0`                                              | `solana_kit_memo`                                                               |
| [compute-budget](https://github.com/solana-program/compute-budget)                            | `js@v0.19.0`                                              | `solana_kit_compute_budget`                                                     |
| [stake](https://github.com/solana-program/stake)                                              | `js@v0.10.0`                                              | `solana_kit_stake`                                                              |
| [config](https://github.com/solana-program/config)                                            | `solana-config-program-client@v1.1.0`                     | `solana_kit_config`                                                             |
| [loader-v3](https://github.com/solana-program/loader-v3)                                      | `js@v0.7.0`                                               | `solana_kit_loader`                                                             |
| [loader-v4](https://github.com/solana-program/loader-v4)                                      | `76f8ce27d3bc`                                            | `solana_kit_loader`                                                             |
...
| [mpl-bubblegum](https://github.com/metaplex-foundation/mpl-bubblegum)                         | `ad7d32b47762`                                            | `solana_kit_mpl_bubblegum`                                                      |
