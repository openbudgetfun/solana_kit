...
void main() {
  const feePayerA = Address(
    '7mvYAxeCui21xYkAyQSjh6iBVZPpgVyt7PYv9km8V5mE',
  );
  const feePayerB = Address(
    '5LHng8dLBxCYyR3jdDbobLiRQ6pR74pYtxKohY93RbZN',
  );
  ...
  group('setTransactionMessageFeePayer', () {
    ...
    group('given a transaction with a fee payer already set', () {
      ...
      test(
        'sets the new fee payer on the transaction when it differs from '
        'the existing one',
        () {
