...
void main() {
  ...
  group('compressTransactionMessageUsingAddressLookupTables', () {
    test('should replace a read-only account with a lookup table', () {
      ...
      final transactionMessage = createTransactionMessage(
    ...
    test(
      'should replace multiple accounts with different addresses from a '
      'lookup table',
      () {
        ...
        final account0 = result.instructions[0].accounts![0]
            as AccountLookupMeta;
        ...
        final account1 = result.instructions[0].accounts![1]
            as AccountLookupMeta;
    ...
    test(
      'should replace the same account in multiple instructions from a '
      'lookup table',
      () {
        const address = Address('address1');
        const lookupTableAddress = Address('lookupTableAddress');
        ...
        final account1 = result.instructions[1].accounts![0]
            as AccountLookupMeta;
    ...
    test(
      'should replace multiple accounts with different addresses from '
    ...
    test(
      'should return the input transaction message if no accounts are '
    ...
    test(
      'should not replace a program address that appears as an account '
      ...
      () {
        ...
        final transactionMessage = appendTransactionMessageInstructions(
          const [
            Instruction(
