...
## solana_kit_mobile_wallet_adapter [0.3.3](https://github.com/openbudgetfun/solana_kit/releases/tag/solana_kit_mobile_wallet_adapter/v0.3.3) (2026-06-01)

### Changed

- No package-specific changes were recorded; `solana_kit_mobile_wallet_adapter` was updated to 0.3.3.
