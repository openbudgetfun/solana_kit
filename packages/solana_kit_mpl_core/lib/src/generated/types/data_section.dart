...
class DataSection {
  ...
  @override
  String toString() => 'DataSection(parentKey: $parentKey, schema: $schema)';
}

Encoder<DataSection> getDataSectionEncoder() {
  ...
  return transformEncoder(
    structEncoder,
    (DataSection value) => <String, Object?>{
...
Decoder<DataSection> getDataSectionDecoder() {
  ...
  return transformDecoder(
    structDecoder,
    (Map<String, Object?> map, Uint8List bytes, int offset) => DataSection(
...
Codec<DataSection, DataSection> getDataSectionCodec() {
