...
class CollectInstructionData {
  const CollectInstructionData() : discriminator = 19;
...
Instruction getCollectInstruction({
  ...
  required Address recipient1,
  required Address recipient2,
}) {
  ...
  return Instruction(
    ...
    accounts: [
      AccountMeta(address: recipient1, role: AccountRole.writable),
      AccountMeta(address: recipient2, role: AccountRole.writable),
    ],
