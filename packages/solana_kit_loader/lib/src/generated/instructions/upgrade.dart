...
Decoder<UpgradeInstructionData> getUpgradeInstructionDataDecoder() {
  ...
  return transformDecoder(
    structDecoder,
    (Map<String, Object?> map, Uint8List bytes, int offset) => UpgradeInstructionData(
      discriminator: map['discriminator']! as int,
    ),
  );
}

Codec<UpgradeInstructionData, UpgradeInstructionData> getUpgradeInstructionDataCodec() {
