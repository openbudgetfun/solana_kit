...
typedef SendTransactionFn<TInput, TResult> = Future<TResult> Function(
  TInput input,
);

/// Plans a batch of transaction inputs.
typedef PlanTransactionsFn<TInput, TPlan> = Future<List<TPlan>> Function(
  List<TInput> inputs,
);

/// Sends a batch of transaction inputs.
typedef SendTransactionsFn<TInput, TResult> = Future<List<TResult>> Function(
  List<TInput> inputs,
);
