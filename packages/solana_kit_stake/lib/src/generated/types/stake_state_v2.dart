...
final class Uninitialized extends StakeStateV2 {
  const Uninitialized();
...
final class Initialized extends StakeStateV2 {
...
final class RewardsPool extends StakeStateV2 {
  const RewardsPool();
...
Decoder<StakeStateV2> getStakeStateV2Decoder() {
  return transformDecoder<Map<String, Object?>, StakeStateV2>(
    ...
    (Map<String, Object?> map, Uint8List bytes, int offset) {
      ...
      throw StateError('Unsupported StakeStateV2 discriminator: ${map['__kind']}');
    },
  );
}
