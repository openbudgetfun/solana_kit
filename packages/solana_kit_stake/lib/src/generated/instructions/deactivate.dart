...
@immutable
class DeactivateInstructionData {
  const DeactivateInstructionData({this.discriminator = 5});
...
Encoder<DeactivateInstructionData> getDeactivateInstructionDataEncoder() {
  ...
  return transformEncoder(
    structEncoder,
    (DeactivateInstructionData value) => <String, Object?>{
...
Decoder<DeactivateInstructionData> getDeactivateInstructionDataDecoder() {
  ...
  return transformDecoder(
    ...
    (Map<String, Object?> map, Uint8List bytes, int offset) =>
        DeactivateInstructionData(discriminator: map['discriminator']! as int),
  );
}
...
Instruction getDeactivateInstruction({
...
/// Parses a [Deactivate] instruction from raw instruction data.
DeactivateInstructionData parseDeactivateInstruction(Instruction instruction) {
  return getDeactivateInstructionDataDecoder().decode(instruction.data!);
}
