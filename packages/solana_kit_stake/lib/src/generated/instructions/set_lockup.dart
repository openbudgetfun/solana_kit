...
import 'definedType:lockup_args';
...
Decoder<SetLockupInstructionData> getSetLockupInstructionDataDecoder() {
  final structDecoder = getStructDecoder(<(String, Decoder<Object?>)>[
    ...
    ('arg0', getLockupArgsDecoder()),
  ]);

  return transformDecoder(
    structDecoder,
    (Map<String, Object?> map, Uint8List bytes, int offset) => SetLockupInstructionData(
      discriminator: map['discriminator']! as int,
      arg0: map['arg0']! as LockupArgs,
    ),
  );
}

Codec<SetLockupInstructionData, SetLockupInstructionData> getSetLockupInstructionDataCodec() {
