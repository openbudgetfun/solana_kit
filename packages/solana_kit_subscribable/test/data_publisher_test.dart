...
void main() {
  group('DataPublisher', () {
    ...
    test('stream extension exposes a typed broadcast stream', () async {
      final received = <int>[];
      final stream = publisher.stream<int>('numbers');
      final subscriptionA = stream.listen(received.add);
      final subscriptionB = stream.listen(received.add);

      publisher
        ..publish('numbers', 1)
        ..publish('numbers', 2);

      expect(received, [1, 1, 2, 2]);
