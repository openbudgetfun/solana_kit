...
## solana_kit_sysvars [0.4.1](https://github.com/openbudgetfun/solana_kit/releases/tag/solana_kit_sysvars/v0.4.1) (2026-08-12)
...
## solana_kit_sysvars [0.5.0](https://github.com/openbudgetfun/solana_kit/releases/tag/solana_kit_sysvars/v0.5.0) (2026-08-30)
...
## solana_kit_sysvars [0.5.1](https://github.com/openbudgetfun/solana_kit/releases/tag/solana_kit_sysvars/v0.5.1) (2026-08-30)

### Changed

- No package-specific changes were recorded; `solana_kit_sysvars` was updated to 0.5.1.

## solana_kit_sysvars [0.5.2](https://github.com/openbudgetfun/solana_kit/releases/tag/solana_kit_sysvars/v0.5.2) (2026-09-06)

### Changed

- No package-specific changes were recorded; `solana_kit_sysvars` was updated to 0.5.2.

## solana_kit_sysvars [0.5.3](https://github.com/openbudgetfun/solana_kit/releases/tag/solana_kit_sysvars/v0.5.3) (2026-09-12)

### Changed

- **No package-specific changes were recorded; `solana_kit_sysvars` was updated to 0.5.3.**

## solana_kit_sysvars [0.6.0](https://github.com/openbudgetfun/solana_kit/releases/tag/solana_kit_sysvars/v0.6.0) (2026-09-21)
