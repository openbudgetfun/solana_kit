...
- **No package-specific changes were recorded; `solana_kit_test_matchers` was updated to 0.9.3 as part of group `main`.**

## [0.9.2](https://github.com/openbudgetfun/solana_kit/releases/tag/v0.9.2) (2026-09-06)

### Changed

- No package-specific changes were recorded; `solana_kit_test_matchers` was updated to 0.9.2 as part of group `main`.

## [0.9.1](https://github.com/openbudgetfun/solana_kit/releases/tag/v0.9.1) (2026-08-30)

### Changed

- No package-specific changes were recorded; `solana_kit_test_matchers` was updated to 0.9.1 as part of group `main`.
...
- No package-specific changes were recorded; `solana_kit_test_matchers` was updated to 0.8.0 as part of group `main`.
