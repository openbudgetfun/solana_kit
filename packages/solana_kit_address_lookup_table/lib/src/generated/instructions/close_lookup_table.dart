...
Encoder<CloseLookupTableInstructionData> getCloseLookupTableInstructionDataEncoder() {
...
Decoder<CloseLookupTableInstructionData> getCloseLookupTableInstructionDataDecoder() {
  ...
  return transformDecoder(
    structDecoder,
    (Map<String, Object?> map, Uint8List bytes, int offset) => CloseLookupTableInstructionData(
      discriminator: map['discriminator']! as int,
    ),
  );
}

Codec<CloseLookupTableInstructionData, CloseLookupTableInstructionData> getCloseLookupTableInstructionDataCodec() {
...
CloseLookupTableInstructionData parseCloseLookupTableInstruction(Instruction instruction) {
