...
/// ThawV2 instruction data for mpl-bubblegum compressed NFTs.
/// The Anchor discriminator for the `thaw_v2` instruction.
const ThawV2InstructionDiscriminator = <int>[
  96,
  133,
  101,
  93,
...
@immutable
class ThawV2InstructionData {
  const ThawV2InstructionData({
    this.discriminator = ThawV2InstructionDiscriminator,
    required this.root,
...
Encoder<ThawV2InstructionData> getThawV2InstructionDataEncoder() {
  ...
  return transformEncoder(
    structEncoder,
    (ThawV2InstructionData value) => <String, Object?>{
...
Decoder<ThawV2InstructionData> getThawV2InstructionDataDecoder() {
...
Codec<ThawV2InstructionData, ThawV2InstructionData>
getThawV2InstructionDataCodec() {
  return combineCodec(
...
/// Creates a [ThawV2] instruction.
Instruction getThawV2Instruction({
  ...
  final instructionData = ThawV2InstructionData(
    root: root,
    dataHash: dataHash,
  ...
  return Instruction(
    ...
    data: getThawV2InstructionDataEncoder().encode(instructionData),
  );
}
