...
/// UnverifyCreatorV2 instruction data for mpl-bubblegum compressed NFTs.
/// The Anchor discriminator for the `unverify_creator_v2` instruction.
const UnverifyCreatorV2InstructionDiscriminator = <int>[
  174,
  112,
  29,
  142,
...
@immutable
class UnverifyCreatorV2InstructionData {
  const UnverifyCreatorV2InstructionData({
    this.discriminator = UnverifyCreatorV2InstructionDiscriminator,
    required this.root,
    this.assetDataHash,
    this.flags,
    required this.nonce,
...
getUnverifyCreatorV2InstructionDataEncoder() {
  ...
  return transformEncoder(
    structEncoder,
    (UnverifyCreatorV2InstructionData value) => <String, Object?>{
...
/// Creates a [UnverifyCreatorV2] instruction.
Instruction getUnverifyCreatorV2Instruction({
  ...
  return Instruction(
    ...
    data: getUnverifyCreatorV2InstructionDataEncoder().encode(instructionData),
  );
}
