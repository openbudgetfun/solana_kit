...
/// BurnV2 instruction data for mpl-bubblegum compressed NFTs.
/// The Anchor discriminator for the `burn_v2` instruction.
const BurnV2InstructionDiscriminator = <int>[
  115,
  210,
  34,
  240,
...
@immutable
class BurnV2InstructionData {
  const BurnV2InstructionData({
    this.discriminator = BurnV2InstructionDiscriminator,
    required this.root,
...
Encoder<BurnV2InstructionData> getBurnV2InstructionDataEncoder() {
  ...
  return transformEncoder(
    structEncoder,
    (BurnV2InstructionData value) => <String, Object?>{
...
Decoder<BurnV2InstructionData> getBurnV2InstructionDataDecoder() {
...
Codec<BurnV2InstructionData, BurnV2InstructionData>
getBurnV2InstructionDataCodec() {
  return combineCodec(
...
/// Creates a [BurnV2] instruction.
Instruction getBurnV2Instruction({
  ...
  final instructionData = BurnV2InstructionData(
    root: root,
    dataHash: dataHash,
  ...
  return Instruction(
    ...
    data: getBurnV2InstructionDataEncoder().encode(instructionData),
  );
}
