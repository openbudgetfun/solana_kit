...
class SetAndVerifyCollectionInstructionData {
  const SetAndVerifyCollectionInstructionData() : discriminator = 25;

  final int discriminator;
}

Encoder<SetAndVerifyCollectionInstructionData>
getSetAndVerifyCollectionInstructionDataEncoder() {
  ...
  return transformEncoder(
    structEncoder,
    (SetAndVerifyCollectionInstructionData value) => <String, Object?>{
      'discriminator': 25,
    },
  );
}

Decoder<SetAndVerifyCollectionInstructionData>
getSetAndVerifyCollectionInstructionDataDecoder() {
  ...
  Never throwInvalidByteLength(int expected, int bytesLength) {
    throw SolanaError(
      ...
      {
        'codecDescription': 'setAndVerifyCollection instruction decoder',
        'expected': expected,
  ...
  (SetAndVerifyCollectionInstructionData, int) readTopLevel(
    Uint8List bytes,
    int offset,
  ) {
    getConstantDecoder(
  ...
  return switch (structDecoder) {
    FixedSizeDecoder<Map<String, Object?>>() =>
      FixedSizeDecoder<SetAndVerifyCollectionInstructionData>(
    ...
    VariableSizeDecoder<Map<String, Object?>>() =>
      VariableSizeDecoder<SetAndVerifyCollectionInstructionData>(
        read: readTopLevel,
...
/// Creates a [SetAndVerifyCollection] instruction.
Instruction getSetAndVerifyCollectionInstruction({
  ...
  final instructionData = SetAndVerifyCollectionInstructionData();
...
/// Parses a [SetAndVerifyCollection] instruction from raw instruction data.
SetAndVerifyCollectionInstructionData parseSetAndVerifyCollectionInstruction(
  Instruction instruction,
) {
  return getSetAndVerifyCollectionInstructionDataDecoder().decode(
    instruction.data!,
  );
}
