...
final class ConfidentialMintBurn extends Extension {
  ...
  @override
  int get hashCode => Object.hash(confidentialSupply, decryptableSupply, supplyElgamalPubkey, pendingBurn);

  @override
  String toString() => 'Extension.ConfidentialMintBurn(confidentialSupply: $confidentialSupply, decryptableSupply: $decryptableSupply, supplyElgamalPubkey: $supplyElgamalPubkey, pendingBurn: $pendingBurn)';
}
...
Encoder<Extension> getExtensionEncoder() {
  return transformEncoder<Map<String, Object?>, Extension>(
    getDiscriminatedUnionEncoder([
      ...
      (24, getStructEncoder([('confidentialSupply', getEncryptedBalanceEncoder()), ('decryptableSupply', getDecryptableBalanceEncoder()), ('supplyElgamalPubkey', getAddressEncoder()), ('pendingBurn', getEncryptedBalanceEncoder())])),
    ...
    (Extension value) => switch (value) {
      ...
      ConfidentialMintBurn(confidentialSupply: final confidentialSupply, decryptableSupply: final decryptableSupply, supplyElgamalPubkey: final supplyElgamalPubkey, pendingBurn: final pendingBurn) => <String, Object?>{'__kind': 24, 'confidentialSupply': confidentialSupply, 'decryptableSupply': decryptableSupply, 'supplyElgamalPubkey': supplyElgamalPubkey, 'pendingBurn': pendingBurn},
...
Decoder<Extension> getExtensionDecoder() {
  return transformDecoder<Map<String, Object?>, Extension>(
    getDiscriminatedUnionDecoder([
      ...
      (24, transformDecoder<Map<String, Object?>, Map<String, Object?>>(getStructDecoder([('confidentialSupply', getEncryptedBalanceDecoder()), ('decryptableSupply', getDecryptableBalanceDecoder()), ('supplyElgamalPubkey', getAddressDecoder()), ('pendingBurn', getEncryptedBalanceDecoder())]), (Map<String, Object?> map, Uint8List bytes, int offset) => map)),
    ...
    (Map<String, Object?> map, Uint8List bytes, int offset) {
      switch (map['__kind']) {
        ...
        case 24: return ConfidentialMintBurn(confidentialSupply: map['confidentialSupply']! as EncryptedBalance, decryptableSupply: map['decryptableSupply']! as DecryptableBalance, supplyElgamalPubkey: map['supplyElgamalPubkey']! as Address, pendingBurn: map['pendingBurn']! as EncryptedBalance);
