...
class SyncNativeInstructionData {
  const SyncNativeInstructionData() : discriminator = 17;
...
Decoder<SyncNativeInstructionData> getSyncNativeInstructionDataDecoder() {
  ...
  Never throwInvalidByteLength(int expected, int bytesLength) {
    throw SolanaError(
      ...
      {
        'codecDescription': 'syncNative instruction decoder',
        'expected': expected,
  ...
  (SyncNativeInstructionData, int) readTopLevel(Uint8List bytes, int offset) {
    getConstantDecoder(
  ...
  return switch (structDecoder) {
    FixedSizeDecoder<Map<String, Object?>>() =>
      FixedSizeDecoder<SyncNativeInstructionData>(
    ...
    VariableSizeDecoder<Map<String, Object?>>() =>
      VariableSizeDecoder<SyncNativeInstructionData>(
        read: readTopLevel,
