...
getInitializePausableConfigInstructionDataDecoder() {
  ...
  Never throwInvalidByteLength(int expected, int bytesLength) {
    throw SolanaError(
      ...
      {
        'codecDescription': 'initializePausableConfig instruction decoder',
        'expected': expected,
  ...
  (InitializePausableConfigInstructionData, int) readTopLevel(
    Uint8List bytes,
    int offset,
  ) {
    getConstantDecoder(
  ...
  return switch (structDecoder) {
    FixedSizeDecoder<Map<String, Object?>>() =>
      FixedSizeDecoder<InitializePausableConfigInstructionData>(
    ...
    VariableSizeDecoder<Map<String, Object?>>() =>
      VariableSizeDecoder<InitializePausableConfigInstructionData>(
        read: readTopLevel,
